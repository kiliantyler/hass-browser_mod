...
function t(e, t, i, o) {
  var s,
    n = arguments.length,
    r =
      n < 3 ? t : null === o ? (o = Object.getOwnPropertyDescriptor(t, i)) : o;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
    r = Reflect.decorate(e, t, i, o);
  else
    for (var a = e.length - 1; a >= 0; a--)
      (s = e[a]) && (r = (n < 3 ? s(r) : n > 3 ? s(t, i, r) : s(t, i)) || r);
  ...
  (e.EventTarget = (function () {
    ...
    return (
      ...
      (e.prototype.dispatchEvent = function (e) {
        ...
        const t = e.type,
          i = this.__listeners.get(t);
        if (i)
          for (const [t, o] of i.entries()) {
            try {
              "function" == typeof t
                ? t.call(this, e)
                : t && "function" == typeof t.handleEvent && t.handleEvent(e);
            } catch (e) {
              setTimeout(() => {
                throw e;
              });
...
const c = window,
  ...
  m = (e, t) => t !== e && (t == t || e == e),
  _ = { attribute: !0, type: String, converter: v, reflect: !1, hasChanged: m };
class g extends HTMLElement {
  ...
  requestUpdate(e, t, i) {
    let o = !0;
    void 0 !== e &&
      (((i = i || this.constructor.getPropertyOptions(e)).hasChanged || m)(
        this[e],
        t
      )
...
(g.finalized = !0),
  ...
  (null !== (l = c.reactiveElementVersions) && void 0 !== l
    ? l
    : (c.reactiveElementVersions = [])
  ).push("1.6.1");
const b = window,
  y = b.trustedTypes,
  f = y ? y.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  ...
  N = new WeakMap(),
  B = x.createTreeWalker(x, 129, null, !1),
  z = (e, t) => {
    const i = e.length - 1,
      o = [];
    let s,
    ...
    for (let t = 0; t < i; t++) {
      ...
      let a,
        ...
        l = -1,
        c = 0;
      for (; c < i.length && ((r.lastIndex = c), (d = r.exec(i)), null !== d); )
        (c = r.lastIndex),
          r === P
            ? "!--" === d[1]
              ? (r = M)
            ...
            ? ">" === d[0]
              ...
              : void 0 === d[1]
              ? (l = -2)
              : ((l = r.lastIndex - d[2].length),
                (a = d[1]),
                (r = void 0 === d[3] ? O : '"' === d[3] ? D : L))
            : r === D || r === L
            ? (r = O)
            : r === M || r === I
            ? (r = P)
      ...
      n +=
        r === P
          ? i + S
          : l >= 0
          ? (o.push(a), i.slice(0, l) + "$lit$" + i.slice(l) + $ + h)
          : i + $ + (-2 === l ? (o.push(void 0), t) : h);
    }
    const a = n + (e[i] || "<?>") + (2 === t ? "</svg>" : "");
    if (!Array.isArray(e) || !e.hasOwnProperty("raw"))
      throw Error("invalid template strings array");
    return [void 0 !== f ? f.createHTML(a) : a, o];
  };
class W {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    for (; null !== (o = B.nextNode()) && a.length < r; ) {
      if (1 === o.nodeType) {
        if (o.hasAttributes()) {
          const e = [];
          for (const t of o.getAttributeNames())
            if (t.endsWith("$lit$") || t.startsWith($)) {
              ...
              if ((e.push(t), void 0 !== i)) {
                const e = o.getAttribute(i.toLowerCase() + "$lit$").split($),
                  t = /([.?@])?(.*)/.exec(i);
                a.push({
                  type: 1,
                  index: s,
        ...
        if (o.data === E) a.push({ type: 2, index: s });
        else {
          let e = -1;
          for (; -1 !== (e = o.data.indexOf($, e + 1)); )
            a.push({ type: 7, index: s }), (e += $.length - 1);
        }
      s++;
    }
  }
  ...
  let d =
    void 0 !== o
      ? null === (s = i._$Co) || void 0 === s
        ...
        : s[o]
      : i._$Cl;
  const l = C(t) ? void 0 : t._$litDirective$;
  return (
    (null == d ? void 0 : d.constructor) !== l &&
      ...
      void 0 !== o
        ...
        : (i._$Cl = d)),
    void 0 !== d && (t = q(e, d._$AS(e, t.values), d, o)),
    t
  );
}
class V {
  ...
  u(e) {
    ...
    for (; void 0 !== d; ) {
      if (r === d.index) {
        let t;
        2 === d.type
          ? (t = new G(n, n.nextSibling, this, e))
          : 1 === d.type
          ? (t = new d.ctor(n, d.name, d.strings, this, e))
          : 6 === d.type && (t = new X(n, this, e)),
          this._$AV.push(t),
          (d = o[++a]);
      }
      r !== (null == d ? void 0 : d.index) && ((n = B.nextNode()), r++);
    }
    return s;
  }
  v(e) {
...
class G {
  constructor(e, t, i, o) {
    ...
    (this.type = 2),
      ...
      (this.options = o),
      (this._$Cp =
        null === (s = null == o ? void 0 : o.isConnected) || void 0 === s || s);
  }
  get _$AU() {
    var e, t;
    return null !==
  ...
  g(e) {
    ...
    const { values: i, _$litType$: o } = e,
      s =
        "number" == typeof o
          ? this._$AC(e)
          : (void 0 === o.el && (o.el = W.createElement(o.h, this.options)), o);
    if ((null === (t = this._$AH) || void 0 === t ? void 0 : t._$AD) === s)
      this._$AH.v(i);
    else {
  ...
  _$AC(e) {
    ...
    return void 0 === t && N.set(e.strings, (t = new W(e))), t;
  }
  T(e) {
    ...
    for (const s of e)
      o === t.length
        ? t.push((i = new G(this.k(A()), this.k(A()), this, this.options)))
        : (i = t[o]),
        i._$AI(s),
        o++;
  ...
  _$AI(e, t = this, i, o) {
    ...
    if (void 0 === s)
      ...
      for (e = s[0], r = 0; r < s.length - 1; r++)
        (a = q(this, o[i + r], t, r)),
          a === j && (a = this._$AH[r]),
          n || (n = !C(a) || a !== this._$AH[r]),
          a === H ? (e = H) : e !== H && (e += (null != a ? a : "") + s[r + 1]),
          (this._$AH[r] = a);
    }
    n && !o && this.j(e);
  }
...
class Q extends F {
  ...
  _$AI(e, t = this) {
    var i;
    if ((e = null !== (i = q(this, e, t, 0)) && void 0 !== i ? i : H) === j)
      return;
    const o = this._$AH,
      s =
        (e === H && o !== H) ||
...
const Y = b.litHtmlPolyfillSupport;
null == Y || Y(W, G),
...
(ie.finalized = !0),
  ...
  null === (ee = globalThis.litElementHydrateSupport) ||
    void 0 === ee ||
    ee.call(globalThis, { LitElement: ie });
const oe = globalThis.litElementPolyfillSupport;
null == oe || oe({ LitElement: ie }),
...
function ae(e, t) {
  return (
    ...
    (i, o) => {
      var s;
      if (void 0 === o) {
        const o = null !== (s = i.originalKey) && void 0 !== s ? s : i.key,
          n =
            null != t
              ? {
                  kind: "method",
      ...
      }
      {
        ...
        void 0 !== t && Object.defineProperty(i, o, t(o)), null == e || e(s, o);
      }
    }
  )({
    descriptor: (i) => {
...
var de;
null === (de = window.HTMLSlotElement) ||
  void 0 === de ||
  de.prototype.assignedElements;
class le extends ie {
  setConfig(e) {}
  render() {
    return R` <div>Nothing to configure.</div> `;
  }
}
customElements.get("browser-player-editor") ||
  (customElements.define("browser-player-editor", le),
...
class ce extends ie {
  ...
  _reconnect() {
    var e;
    (null === (e = window.browser_mod) || void 0 === e
      ? void 0
      : e.registered) ||
      ("hui-card-preview" === this.parentElement.localName
  ...
  async connectedCallback() {
    var e;
    super.connectedCallback(),
      await (null === (e = window.browser_mod) || void 0 === e
        ? void 0
        : e.connectionPromise),
      this._reconnect();
  }
  async setConfig(e) {
    for (var t, i, o, s; !window.browser_mod; )
    ...
    for (const e of [
      ...
      null ===
        (i =
          null === (t = window.browser_mod) || void 0 === t
            ? void 0
            : t._audio_player) ||
        void 0 === i ||
    ...
    null ===
      (s =
        null === (o = window.browser_mod) || void 0 === o
          ? void 0
          : o._video_player) ||
      void 0 === s ||
      s.addEventListener(event, () => this.requestUpdate());
  }
  handleMute(e) {
  ...
  handleVolumeChange(e) {
    ...
    window.browser_mod.player.volume = t;
  }
  handleMoreInfo(e) {
    var t;
    this.dispatchEvent(
      new CustomEvent("hass-more-info", {
        ...
        detail: {
          entityId:
            null === (t = window.browser_mod.browserEntities) || void 0 === t
              ? void 0
              : t.player,
        },
      })
  ...
  render() {
    ...
    `
      ...
      `
      : (window.setTimeout(() => this.requestUpdate(), 100), R``);
  }
  static get styles() {
    return a`
      :host(["hidden"]) {
...
t([ne()], ce.prototype, "hass", void 0),
  t(
    [ne({ attribute: "edit-mode", reflect: !0 })],
    ce.prototype,
    "editMode",
    void 0
  ),
  customElements.get("browser-player") ||
    customElements.define("browser-player", ce);
async function he(e, t = !1) {
  ...
  if (
    ...
    t && (e.pageRendered && (await e.pageRendered), e._panelState))
  ) {
    let t = 0;
    for (; "loaded" !== e._panelState && t++ < 5; )
      await new Promise((e) => setTimeout(e, 100));
  }
}
async function ue(e, t, i = !1) {
  let o = [e];
  for (
  ...
  for (const [e, i] of t.entries()) {
    ...
    if (!e) return null;
    i.trim().length &&
      (he(e), (o = "$" === i ? [e.shadowRoot] : e.querySelectorAll(i)));
  }
  return i ? o : o[0];
}
async function pe(e, t, i = !1, o = 1e4) {
  return Promise.race([
    ue(e, t, i),
    new Promise((e, t) =>
      setTimeout(() => t(new Error("SELECTTREE-TIMEOUT")), o)
    ),
  ]).catch((e) => {
    if (!e.message || "SELECTTREE-TIMEOUT" !== e.message) throw e;
    return null;
  });
}
async function ve() {
  ...
  const e = customElements.get("home-assistant") ? "home-assistant" : "hc-main";
...
const ge = async () => {
    ...
    const o = document
      .createElement("partial-panel-resolver")
      .getRoutes([{ component_name: "lovelace", url_path: "a" }]);
    await (null ===
      (i =
        null ===
          (t =
            null === (e = null == o ? void 0 : o.routes) || void 0 === e
              ? void 0
              : e.a) || void 0 === t
          ? void 0
          : t.load) || void 0 === i
    ...
    try {
      ...
      (e.hass = await me()),
        (e.panel = { config: { mode: "yaml" } }),
        await e._fetchConfig(!1);
    } catch (e) {}
  },
  we = async () => {
...
function be(e = !1) {
  return function (t, i, o) {
    ...
    let n;
    const r = function (...t) {
      if ((e && !1 === n && (n = !0), void 0 !== n)) return;
      n = !1;
      const i = s.bind(this)(...t);
      return n ? ((n = void 0), r.bind(this)(...t)) : ((n = void 0), i);
    };
    o.value = r;
  };
}
const ye = (e) =>
    class extends e {
      ...
      LOG(...e) {
        ...
        const t = new Date();
        console.log(`${t.toLocaleTimeString()}`, ...e),
      ...
      fireEvent(e, t) {
        this.dispatchEvent(new CustomEvent(e, { detail: t, bubbles: !0 }));
      }
      incoming_message(e) {
        var t;
        e.command
          ? (this.LOG("Command:", e), this.fireEvent(`command-${e.command}`, e))
          : e.browserEntities
          ? (this.browserEntities = e.browserEntities)
          : e.result && this.update_config(e.result),
          null === (t = this._connectionResolve) ||
            void 0 === t ||
            t.call(this),
      ...
      update_config(e) {
        ...
        let i = !1;
        !this.registered &&
          (null === (t = e.browsers) || void 0 === t
            ? void 0
            : t[this.browserID]) &&
          (i = !0),
          (this._data = e),
          this.registered ||
            !0 !== this.global_settings.autoRegister ||
            (this.registered = !0),
          this.connected ||
            ((this.connected = !0), this.fireEvent("browser-mod-connected")),
          this.fireEvent("browser-mod-config-update"),
          i && this.sendUpdate({});
      }
      async connect() {
        const e = (await me()).connection;
        (this.connection = e),
          ...
          e.addEventListener("disconnected", () => {
            (this.connected = !1), this.fireEvent("browser-mod-disconnected");
          }),
      ...
      get config() {
        var e, t;
        return null !==
          (t = null === (e = this._data) || void 0 === e ? void 0 : e.config) &&
          void 0 !== t
          ? t
          : {};
      }
      get browsers() {
        ...
        return null !==
          (t =
            null === (e = this._data) || void 0 === e ? void 0 : e.browsers) &&
          void 0 !== t
          ? t
          : [];
      }
      ...
      async _reregister(e = {}) {
        await this.connection.sendMessage({
          ...
          browserID: this.browserID,
          data: Object.assign(
            Object.assign({}, this.browsers[this.browserID]),
            e
          ),
        });
      }
        ...
        const i = {},
          o =
            null !==
              ...
              ? t
              : {};
        for (const [e, t] of Object.entries(o)) null !== t && (i[e] = t);
        return i;
      }
      get user_settings() {
        var e, t, i, o, s;
        const n = {},
          r =
            null !==
              ...
              ? s
              : {};
        for (const [e, t] of Object.entries(r)) null !== t && (n[e] = t);
        return n;
      }
        ...
        const o = {},
          s =
            null !==
              ...
              ? i
              : {};
        for (const [e, t] of Object.entries(s)) null !== t && (o[e] = t);
        return o;
      }
      get settings() {
        return Object.assign(
          Object.assign(
            Object.assign({}, this.global_settings),
      ...
      set_setting(e, t, i) {
        ...
        switch (i) {
          ...
          case "browser": {
            const i =
              null === (o = this.browsers[this.browserID]) || void 0 === o
                ? void 0
                : o.settings;
      ...
      get cameraEnabled() {
        return this.registered ? this.browsers[this.browserID].camera : null;
      }
      set cameraEnabled(e) {
        this._reregister({ camera: e });
      }
      sendUpdate(e) {
        this.connected &&
          this.registered &&
      ...
      browserIDChanged(e, t) {
        ...
        this.fireEvent("browser-mod-config-update"),
          void 0 !==
            (null === (i = this.browsers) || void 0 === i ? void 0 : i[e]) &&
            void 0 ===
              (null === (o = this.browsers) || void 0 === o
                ? void 0
                : o[this.browserID]) &&
            (async () => {
              await this.connection.sendMessage({
                type: "browser_mod/register",
                browserID: e,
                data: Object.assign(Object.assign({}, this.browsers[e]), {
                  browserID: this.browserID,
                }),
              });
            })();
    ...
    class extends e {
      constructor() {
        ...
        e.shadowRoot.append(t),
          ...
          this.addEventListener("command-screen_on", (e) => this._screen_on(e)),
      ...
      send_screen_status() {
        let e = !this._panel.hasAttribute("dark"),
          t = this._brightness;
        this.fully && ((e = this.fully_screen), (t = this.fully_brightness)),
          this.sendUpdate({ screen_on: e, screen_brightness: t });
      }
      _screen_off() {
        this.fully
          ? (this.fully_screen = !1)
        ...
        this.fully
          ? ((this.fully_screen = !0),
            (null === (t = null == e ? void 0 : e.detail) || void 0 === t
              ? void 0
              : t.brightness) && (this.fully_brightness = e.detail.brightness))
          : ((null === (i = null == e ? void 0 : e.detail) || void 0 === i
              ...
              this._panel.style.setProperty(
                "--darkness",
                1 - e.detail.brightness / 255
              )),
            this._panel.removeAttribute("dark")),
          this.send_screen_status();
        for (const e of ["pointerdown", "pointermove", "keydown"])
          this._listeners[e] &&
            (window.removeEventListener(e, this._listeners[e]),
            (this._listeners[e] = void 0));
      }
    },
  $e = (e) => {
    class i extends e {
      constructor() {
        ...
        for (const e of ["timeupdate"])
          this._audio_player.addEventListener(e, () =>
            this._player_update_throttled()
          ),
            this._video_player.addEventListener(e, () =>
              this._player_update_throttled()
            );
        this.firstInteraction.then(() => {
          (this._player_enabled = !0), this.player.ended || this.player.play();
        }),
              ...
              (null === (t = e.detail) || void 0 === t
                ...
                ((
                  null === (i = e.detail) || void 0 === i
                    ? void 0
                    : i.media_type.startsWith("video")
                )
                  ? (this.player = this._video_player)
                  : (this.player = this._audio_player)),
              (null === (o = e.detail) || void 0 === o
                ? void 0
                : o.media_content_id) &&
          ...
          this.addEventListener("command-player-pause", (e) =>
            this.player.pause()
          ),
          ...
          this.addEventListener("command-player-mute", (e) => {
            var t;
            void 0 !==
            (null === (t = e.detail) || void 0 === t ? void 0 : t.mute)
              ? (this.player.muted = Boolean(e.detail.mute))
      ...
      _show_video_player() {
        this.player === this._video_player && this.player.src
          ? (pe(document, "home-assistant $ dialog-media-player-browse").then(
              (e) => (null == e ? void 0 : e.closeDialog())
            ),
            this.showPopup(void 0, this._video_player, {
        ...
        [
          ...
          function (e, t, i) {
            ...
            i.value = function (...e) {
              if (!n)
                return (
                  (n = setTimeout(() => (n = void 0), o)), s.bind(this)(...e)
                );
            };
          }),
        ],
  ...
  Ee = (e) =>
    class extends e {
      ...
      async _setup_camera() {
        ...
        e.shadowRoot.append(t),
          (t.innerHTML = "\n      :host {\n        display: none;\n      }");
        const i = (this._video = document.createElement("video"));
        e.shadowRoot.append(i),
          (i.autoplay = !0),
          (i.playsInline = !0),
          (i.style.display = "none");
        const o = (this._canvas = document.createElement("canvas"));
        if (
          (e.shadowRoot.append(o),
      ...
      async update_camera() {
        ...
        if (!this.cameraEnabled) {
          const t =
            null === (e = this._video) || void 0 === e ? void 0 : e.srcObject;
          return void (
            t &&
            (t.getTracks().forEach((e) => e.stop()),
            (this._video.scrObject = void 0))
          );
        }
        if (this.fully) this.sendUpdate({ camera: this.fully_camera });
        else {
          const e = this._video,
            t = e.videoWidth,
            i = e.videoHeight;
        ...
        const t = Math.round(1e3 / this._framerate);
        setTimeout(() => this.update_camera(), t);
      }
    },
  Se = (e) =>
    class extends e {
      constructor() {
        super(),
          (this.firstInteraction = new Promise((e) => {
            this._interactionResolve = e;
          })),
          this.show_indicator();
      }
      async show_indicator() {
        ...
        const e = document.createElement("div");
        document.body.append(e),
          e.classList.add("browser-mod-require-interaction"),
          e.attachShadow({ mode: "open" });
        const t = document.createElement("style");
        e.shadowRoot.append(t),
          (t.innerHTML =
        ...
        e.shadowRoot.append(i), (i.icon = "mdi:gesture-tap");
        const o = (this._video = document.createElement("video"));
        e.shadowRoot.append(o);
        const s = o.play();
        s &&
          (s
            .then(() => {
              this._interactionResolve(), o.pause();
            })
            .catch((e) => {}),
          o.pause()),
          ...
          this.fully && this._interactionResolve(),
          await this.firstInteraction,
          e.remove();
      }
    },
  xe = (e) =>
    class extends e {
      ...
      constructor() {
        if ((super(), (this._fully_screensaver = !1), this.fully)) {
          for (const e of [
            "screenOn",
            "screenOff",
            "pluggedAC",
      ...
      get fully_screen() {
        var e;
        return (
          !1 === this._fully_screensaver &&
          (null === (e = window.fully) || void 0 === e
            ? void 0
            : e.getScreenOn())
        );
      }
      set fully_screen(e) {
        var t, i, o;
        e
          ? (null === (t = window.fully) || void 0 === t || t.turnScreenOn(),
            null === (i = window.fully) || void 0 === i || i.stopScreensaver())
          : null === (o = window.fully) || void 0 === o || o.turnScreenOff();
      }
      get fully_brightness() {
        var e;
        return null === (e = window.fully) || void 0 === e
          ? void 0
          : e.getScreenBrightness();
      }
      set fully_brightness(e) {
        var t;
        null === (t = window.fully) || void 0 === t || t.setScreenBrightness(e);
      }
      get fully_camera() {
        var e;
        return null === (e = window.fully) || void 0 === e
          ? void 0
          : e.getCamshotJpgBase64();
      }
      get fully_data() {
        const e = window.fully;
        if (void 0 === e) return "undefined";
        try {
          return {
            ip4Address: e.getIp4Address(),
            ip6Address: e.getIp6Address(),
            hostname: e.getHostname(),
            hostname6: e.getHostname6(),
            macAddress: e.getMacAddress(),
            wifiSsid: e.getWifiSsid(),
            wifiBssid: e.getWifiBssid(),
            wifiSignalLevel: e.getWifiSignalLevel(),
            serialNumber: e.getSerialNumber(),
            androidId: e.getAndroidId(),
            deviceId: e.getDeviceId(),
            deviceName: e.getDeviceName(),
            imei: e.getImei(),
            simSerialNumber: e.getSimSerialNumber(),
            batteryLevel: e.getBatteryLevel(),
            screenBrightness: e.getScreenBrightness(),
            screenOrientation: e.getScreenOrientation(),
            displayWidth: e.getDisplayWidth(),
            displayHeight: e.getDisplayHeight(),
            screenOn: e.getScreenOn(),
            plugged: e.isPlugged(),
            keyboardVisible: e.isKeyboardVisible(),
            wifiEnabled: e.isWifiEnabled(),
            wifiConnected: e.isWifiConnected(),
            networkConnected: e.isNetworkConnected(),
            bluetoothEnabled: e.isBluetoothEnabled(),
            screenRotationLocked: e.isScreenRotationLocked(),
            fullyVersion: e.getFullyVersion(),
            fullyVersionCode: e.getFullyVersionCode(),
            webViewVersion: e.getWebviewVersion(),
            androidVersion: e.getAndroidVersion(),
            androidSdk: e.getAndroidSdk(),
            deviceModel: e.getDeviceModel(),
            internalStorageTotalSpace: e.getInternalStorageTotalSpace(),
            internalStorageFreeSpace: e.getInternalStorageFreeSpace(),
            externalStorageTotalSpace: e.getExternalStorageTotalSpace(),
            externalStorageFreeSpace: e.getExternalStorageFreeSpace(),
            sensorInfo: e.getSensorInfo(),
            allRxBytesMobile: e.getAllRxBytesMobile(),
            allTxBytesMobile: e.getAllTxBytesMobile(),
            allRxBytesWifi: e.getAllRxBytesWifi(),
            allTxBytesWifi: e.getAllTxBytesWifi(),
          };
        } catch (e) {
          return String(e);
        }
      ...
      fullyEvent(e) {
        this.fireEvent("fully-update", { event: e });
      }
    },
  Ae = (e) =>
    class extends e {
      ...
      _browser_state_update() {
        (async () => {
          var e, t, i, o, s, n, r, a, d, l;
          const c = navigator.getBattery
            ...
            browser: {
              ...
              currentUser:
                null ===
                  ...
                  ? void 0
                  : t.name,
              fullyKiosk: this.fully || !1,
              width: window.innerWidth,
              height: window.innerHeight,
              battery_level:
                null !==
                  (o =
                    null === (i = window.fully) || void 0 === i
                      ? void 0
                      : i.getBatteryLevel()) && void 0 !== o
                  ? o
                  : 100 * (null == c ? void 0 : c.level),
              charging:
                null !==
                  (n =
                    null === (s = window.fully) || void 0 === s
                      ? void 0
                      : s.isPlugged()) && void 0 !== n
                  ? n
                  : null == c
                  ? void 0
                  : c.charging,
              darkMode:
                null ===
                  ...
                  : a.darkMode,
              userData:
                null === (d = this.hass) || void 0 === d ? void 0 : d.user,
              ip_address:
                null === (l = window.fully) || void 0 === l
                  ? void 0
                  : l.getIp4Address(),
  ...
  Ce = (e) =>
    class extends e {
      constructor() {
        ...
        for (const t of e)
          this.addEventListener(`command-${t}`, (e) => {
            this.service(t, e.detail);
          });
        document.body.addEventListener("ll-custom", (e) => {
          e.detail.browser_mod && this._service_action(e.detail.browser_mod);
        });
      }
      async service(e, t) {
        this._service_action({ service: e, data: t });
      }
      async _service_action({ service: e, data: t }) {
        if ((void 0 === t && (t = {}), !e))
        ...
        let i = e;
        if (
          (!i.startsWith("browser_mod.") && i.includes(".")) ||
          void 0 !== t.browser_id
        ) {
          const e = Object.assign({}, t);
          "THIS" === e.browser_id && (e.browser_id = this.browserID);
          const [o, s] = i.split(".");
          return this.hass.callService(o, s, e);
        }
        switch ((i.startsWith("browser_mod.") && (i = i.substring(12)), i)) {
          case "sequence":
            for (const e of t.sequence) await this._service_action(e);
            break;
          case "delay":
            await new Promise((e) => setTimeout(e, t.time));
            break;
          case "more_info":
            const { entity: e, large: i, ignore_popup_card: o } = t;
            this.showMoreInfo(e, i, o);
            break;
          case "popup":
            const { title: s, content: n } = t,
              r = (function (e, t) {
                var i = {};
                for (var o in e)
            ...
            for (const [e, t] of Object.entries(r))
              e.endsWith("_action") &&
                (r[e] = (e) => {
                  const { service: i, data: o } = t;
                  this._service_action({
                    service: i,
                    data: Object.assign(Object.assign({}, o), e),
                  });
                });
            this.showPopup(s, n, r);
            break;
          case "notification":
            {
              const {
              ...
              o &&
                ...
                (r = {
                  text: i,
                  action: (e) => {
                    const { service: t, data: i } = o;
                    this._service_action({
                      service: t,
                      data: Object.assign(Object.assign({}, i), e),
                    });
                  },
                });
              (await ve()).dispatchEvent(
          ...
          case "set_theme":
            {
              const e = Object.assign({}, t);
              if (
                ("auto" === e.theme && (e.theme = void 0),
                "auto" === e.dark && (e.dark = void 0),
                "light" === e.dark && (e.dark = !1),
                "dark" === e.dark && (e.dark = !0),
                e.primaryColor && Array.isArray(e.primaryColor))
              ) {
                const [t, i, o] = e.primaryColor;
                e.primaryColor =
                  "#" +
                  ((1 << 24) + (t << 16) + (i << 8) + o).toString(16).slice(1);
              }
              if (e.accentColor && Array.isArray(e.accentColor)) {
                const [t, i, o] = e.accentColor;
                e.accentColor =
                  "#" +
                  ((1 << 24) + (t << 16) + (i << 8) + o).toString(16).slice(1);
              }
              (await ve()).dispatchEvent(
                new CustomEvent("settheme", { detail: e })
              );
            }
            break;
          case "console":
            Object.keys(t).length > 1 || (t && void 0 === t.message)
              ? console.dir(t)
          ...
          case "javascript":
            const a = async () => {
                ...
                e ||
                  (e = await pe(document, "hc-main $ hc-lovelace $ hui-view")),
                  e ||
                    (e = await pe(
                      document,
            ...
            new Function(
              ...
              "lovelace_reload",
              l
            )(this.hass, t, window.browser_mod.service, d, a);
        }
      }
    },
  Te = (e) =>
    class extends e {
      ...
      activityTrigger(e = !1) {
        this.activityTriggered || this.sendUpdate({ activity: !0 }),
          (this.activityTriggered = !0),
          e && this.fireEvent("browser-mod-activity"),
      ...
      activityReset() {
        clearTimeout(this._activityTimeout),
          this.activityTriggered && this.sendUpdate({ activity: !1 }),
...
class Pe extends class {
  ...
  constructor(e) {
    if ((super(e), (this.et = H), e.type !== ke))
      throw Error(
        this.constructor.directiveName + "() can only be used in child bindings"
      );
  }
  render(e) {
    if (e === H || null == e) return (this.ft = void 0), (this.et = e);
    if (e === j) return e;
    if ("string" != typeof e)
      throw Error(
...
class Ie extends ie {
  async closeDialog() {
    ...
    (this.open = !1),
      null ===
        (t = null === (e = this.card) || void 0 === e ? void 0 : e.remove) ||
        void 0 === t ||
        t.call(e),
      (this.card = void 0),
      ...
      null ===
        (o =
          null === (i = this._actions) || void 0 === i
            ? void 0
            : i.dismiss_action) ||
        void 0 === o ||
        o.call(i),
      (null === (s = this._cardMod) || void 0 === s ? void 0 : s[0]) &&
  ...
  openDialog() {
    ...
    (this.open = !0),
      ...
      this.timeout &&
        ...
        (this._timeoutTimer = setInterval(() => {
          ...
          this.style.setProperty("--progress", `${t}%`),
            e >= this.timeout &&
              (clearInterval(this._timeoutTimer), this._timeout());
        }, 10))),
      (this._autocloseListener = void 0),
      this._autoclose &&
      ...
      customElements.whenDefined("card-mod").then(() => {
        ...
        null ===
          (t =
            null === (e = customElements.get("card-mod")) || void 0 === e
              ? void 0
              : e.applyToElement) ||
          void 0 === t ||
          t.call(
  ...
  async setupDialog(
    ...
    {
      right_button: i,
      right_button_action: o,
      left_button: s,
      left_button_action: n,
      dismissable: r = !0,
      dismiss_action: a,
      timeout: d,
      timeout_action: l,
    ...
    if (
      ...
      (e.schema = t),
        ...
        (e.hass = window.browser_mod.hass),
        (this._formdata = {});
      for (const e of t)
        e.name && void 0 !== e.default && (this._formdata[e.name] = e.default);
      (e.data = this._formdata),
        _e(e),
        e.addEventListener("value-changed", (t) => {
          (this._formdata = Object.assign({}, t.detail.value)),
            (e.data = this._formdata);
        }),
        e.addEventListener("closing", (e) => {
          e.stopPropagation(), e.preventDefault();
        });
      const i = document.createElement("ha-card");
      i.append(e), (this.content = i);
    } else
      t && "object" == typeof t
    ...
    (this.right_button = i),
      ...
      (this.wide = "wide" === c ? "" : void 0),
      (this.fullscreen = "fullscreen" === c ? "" : void 0),
      (this._style = h),
      (this._autoclose = u);
  }
  async do_close() {
    ...
    (null === (t = this._actions) || void 0 === t
      ? void 0
      : t.dismiss_action) && (this._actions.dismiss_action = void 0),
      await (null === (i = this.dialog) || void 0 === i ? void 0 : i.close()),
      null == o || o(this._formdata);
  }
  async _primary() {
    var e, t, i;
    (null === (e = this._actions) || void 0 === e
      ? void 0
      : e.dismiss_action) && (this._actions.dismiss_action = void 0),
      await this.do_close(),
      null ===
        (i =
          null === (t = this._actions) || void 0 === t
            ? void 0
            : t.right_button_action) ||
        void 0 === i ||
...
t([ne()], Ie.prototype, "open", void 0),
  t([ne()], Ie.prototype, "content", void 0),
  t([ne()], Ie.prototype, "title", void 0),
  t([ne({ reflect: !0 })], Ie.prototype, "actions", void 0),
  t([ne({ reflect: !0 })], Ie.prototype, "card", void 0),
  t([ne()], Ie.prototype, "right_button", void 0),
  t([ne()], Ie.prototype, "left_button", void 0),
  t([ne()], Ie.prototype, "dismissable", void 0),
  t([ne({ reflect: !0 })], Ie.prototype, "wide", void 0),
  t([ne({ reflect: !0 })], Ie.prototype, "fullscreen", void 0),
  t([ne()], Ie.prototype, "_style", void 0),
  t([ae("ha-dialog")], Ie.prototype, "dialog", void 0),
  customElements.get("browser-mod-popup") ||
    customElements.define("browser-mod-popup", Ie);
const Oe = (e) =>
  class extends e {
    constructor() {
      super(),
        ...
        this._popupEl.addEventListener("hass-more-info", async (e) => {
          e.stopPropagation();
          const t = await ve();
          this._popupEl.do_close(), t.dispatchEvent(e);
        });
      window.addEventListener("popstate", async (e) => {
        var t, i, o;
        const s =
          null === (t = e.state) || void 0 === t ? void 0 : t.browserModPopup;
        s &&
          (s.open ||
            ((null === (i = this._popupEl) || void 0 === i ? void 0 : i.open) &&
              (null === (o = this._popupEl) || void 0 === o
                ? void 0
                : o.dismissable) &&
    ...
    showPopup(...e) {
      (async () => {
        var t;
        this._popupEl.open && (await this._popupEl.do_close()),
          void 0 ===
            (null === (t = history.state) || void 0 === t
              ? void 0
              : t.browserModPopup) &&
            history.replaceState({ browserModPopup: { open: !1 } }, ""),
          history.pushState({ browserModPopup: { open: !0 } }, ""),
          await this._popupEl.setupDialog(...e),
          this._popupEl.openDialog();
      })();
    }
    closePopup(...e) {
      this._popupEl.closeDialog(), this.showMoreInfo("");
    }
    async showMoreInfo(e, t = !1, i) {
      const o = await ve();
      if (
        (o.dispatchEvent(
          new CustomEvent("hass-more-info", {
            ...
            composed: !0,
            cancelable: !1,
            detail: { entityId: e, ignore_popup_card: i },
          })
        ),
        t)
      ) {
        await new Promise((e) => setTimeout(e, 50));
        const e = o.shadowRoot.querySelector("ha-more-info-dialog");
        e && (e.large = !0);
      }
    }
  };
...
const De = [
  ...
  },
  {
    type: "grid",
    schema: [
      { name: "right_button", label: "Right button", selector: { text: {} } },
      { name: "left_button", label: "Left button", selector: { text: {} } },
    ],
  },
  {
    type: "grid",
  ...
  { name: "style", label: "CSS style", selector: { text: { multiline: !0 } } },
];
class Ue extends ie {
  constructor() {
    super(...arguments),
  ...
  connectedCallback() {
    super.connectedCallback(), we();
  }
  _handleSwitchTab(e) {
    this._selectedTab = parseInt(e.detail.index, 10);
  }
  _configChanged(e) {
    e.stopPropagation(),
      this._config &&
  ...
  _toggleCardMode(e) {
    var t;
    null === (t = this._cardEditorEl) || void 0 === t || t.toggleMode();
  }
  _deleteCard(e) {
    this._config &&
...
t([re()], Ue.prototype, "_config", void 0),
  t([ne()], Ue.prototype, "lovelace", void 0),
  t([ne()], Ue.prototype, "hass", void 0),
  t([re()], Ue.prototype, "_selectedTab", void 0),
  t([re()], Ue.prototype, "_cardGUIMode", void 0),
  t([re()], Ue.prototype, "_cardGUIModeAvailable", void 0),
  t([ae("hui-card-element-editor")], Ue.prototype, "_cardEditorEl", void 0),
  (async () => {
    for (; !window.browser_mod; ) await new Promise((e) => setTimeout(e, 1e3));
    await window.browser_mod.connectionPromise,
      customElements.get("popup-card-editor") ||
        (customElements.define("popup-card-editor", Ue),
        (window.customCards = window.customCards || []),
        window.customCards.push({
          type: "popup-card",
          name: "Popup card",
...
class Re extends ie {
  ...
  constructor() {
    super(), (this.popup = this.popup.bind(this));
  }
  setConfig(e) {
    (this._config = e),
      (async () => {
  ...
  async connectedCallback() {
    super.connectedCallback(),
      ...
      "hui-card-preview" === this.parentElement.localName
        ? ((this.editMode = !0), this.removeAttribute("hidden"))
        : this.setAttribute("hidden", "");
  }
  ...
  popup(e) {
    var t, i, o;
    if (
      (null === (t = e.detail) || void 0 === t ? void 0 : t.entityId) ===
        this._config.entity &&
      !(null === (i = e.detail) || void 0 === i ? void 0 : i.ignore_popup_card)
    ) {
      e.stopPropagation(), e.preventDefault();
      delete Object.assign({}, this._config).card,
        null === (o = window.browser_mod) ||
          void 0 === o ||
          o.service(
            "popup",
            Object.assign({ content: this._config.card }, this._config)
          ),
        setTimeout(
          () =>
            this.dispatchEvent(
...
t([ne()], Re.prototype, "hass", void 0),
  t([re()], Re.prototype, "_config", void 0),
  t(
    [ne({ attribute: "edit-mode", reflect: !0 })],
    Re.prototype,
    "editMode",
  ...
  t([re()], Re.prototype, "_element", void 0),
  (async () => {
    for (; !window.browser_mod; ) await new Promise((e) => setTimeout(e, 1e3));
    await window.browser_mod.connectionPromise,
      customElements.get("popup-card") ||
        customElements.define("popup-card", Re);
  })();
const je = (e) => {
    class i extends e {
      async runHideHeader() {
        for (; !(await this._hideHeader()); )
      ...
      constructor() {
        super(), (this.__currentTitle = void 0);
        const e = async () => {
          this.runUpdateTitle(), this.runHideHeader();
        };
      ...
      async _auto_settings_setup() {
        ...
        e.sidebarPanelOrder &&
          ...
          e.defaultPanel &&
            localStorage.setItem("defaultPanel", `"${e.defaultPanel}"`),
          !0 === e.hideSidebar &&
            (pe(
              document.body,
              ...
              var t;
              return null === (t = null == e ? void 0 : e.style) || void 0 === t
                ? void 0
                : t.setProperty("--mdc-drawer-width", "0px");
            }),
            pe(
              document.body,
              ...
              var t;
              return null === (t = null == e ? void 0 : e.remove) ||
                void 0 === t
                ? void 0
                : t.call(e);
            })),
      ...
      get _currentFavicon() {
        const e = document.head.querySelector("link[rel~='icon']");
        return null == e ? void 0 : e.href;
      }
      _updateFavicon({ result: e }) {
        document.head.querySelector("link[rel~='icon']").href = e;
      }
      get _currentTitle() {
      ...
      async _hideHeader() {
        var e, t, i;
        if (!0 !== this.settings.hideHeader && !0 !== this.settings.hideSidebar)
          return !0;
        const o = await pe(
          document,
        ...
        if (!o) return !1;
        let s,
          n = await pe(o, "ha-panel-lovelace$hui-root$.header");
        if (n) s = n.querySelector("ha-menu-button");
        else {
          let i = 0,
            r = o;
          for (; r && "ha-top-app-bar-fixed" !== r.localName && i++ < 5; ) {
            ...
            const i =
              null !==
                (t =
                  null !== (e = r.querySelector("ha-top-app-bar-fixed")) &&
                  void 0 !== e
                    ? e
                    : r.firstElementChild) && void 0 !== t
                ? t
                : r.shadowRoot;
            r = i;
          }
          if ("ha-top-app-bar-fixed" !== (null == r ? void 0 : r.localName))
            return !1;
          (n = r.shadowRoot.querySelector("header")),
            (s = r.querySelector("ha-menu-button"));
        }
        return n && !0 === this.settings.hideHeader
          ? (o.style.setProperty("--header-height", "0px"),
            n.style.setProperty("display", "none"),
            !0)
          : !(!s || !0 !== this.settings.hideSidebar) &&
              (null === (i = s.remove) || void 0 === i || i.call(s), !0);
      }
      getSetting(e) {
        var t, i, o, s;
        const n = { global: void 0, browser: {}, user: {} };
        n.global =
          null === (t = this._data.settings) || void 0 === t ? void 0 : t[e];
        for (const [t, s] of Object.entries(
          null !== (i = this._data.browsers) && void 0 !== i ? i : {}
        ))
          null != (null === (o = s.settings) || void 0 === o ? void 0 : o[e]) &&
            (n.browser[t] = s.settings[e]);
        for (const [t, i] of Object.entries(
          null !== (s = this._data.user_settings) && void 0 !== s ? s : {}
        ))
          null != i[e] && (n.user[t] = i[e]);
        return n;
      }
      setSetting(e, t, i) {
        if ("global" === e)
          ...
          const e = this._data.browsers[t],
            o = Object.assign(Object.assign({}, e.settings), i);
          this.connection.sendMessage({
            type: "browser_mod/register",
            browserID: t,
            data: Object.assign(Object.assign({}, e), { settings: o }),
          });
        } else if ("user" === e) {
          const e = t;
    ...
    return (
      t([be()], i.prototype, "runHideHeader", null),
      t([be(!0)], i.prototype, "runUpdateTitle", null),
      i
    );
  },
  He = "browser_mod-browser-id",
  Ne = (e) =>
    class extends e {
      constructor() {
        if ((super(), Storage && !Storage.prototype.browser_mod_patched)) {
          ...
          (Storage.prototype.clear = function () {
            const t = this.getItem(He),
              i = this.getItem("suspendWhenHidden");
            e.apply(this),
              this.setItem(He, t),
              this.setItem("suspendWhenHidden", i);
          }),
      ...
      async recall_id() {
        ...
        const e = await this.connection.sendMessagePromise({
          ...
          (e = (function () {
            ...
            return null !==
              (t =
                null === (e = window.fully) || void 0 === e
                  ? void 0
                  : e.getDeviceId()) && void 0 !== t
              ? t
              : `${i()}${i()}-${i()}${i()}`;
          })());
        const t = localStorage[He];
        (localStorage[He] = e), this.browserIDChanged(t, e);
      }
      browserIDChanged(e, t) {}
    };
class Be extends Ce(Oe(Te(Ae(Ee($e(fe(je(xe(Se(ye(Ne(EventTarget)))))))))))) {
  constructor() {
    super(),
      this.connect(),
      console.info(
...
window.browser_mod || (window.browser_mod = new Be());
export { Be as BrowserMod };
